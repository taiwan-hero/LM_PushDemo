...
- (void)createAlert:(NSDictionary *)msg {
    NSString *textMsg = msg[@"aps"][@"alert"];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Message Received" message:[NSString stringWithFormat:@"%@", textMsg]delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
    [alertView show];
}
